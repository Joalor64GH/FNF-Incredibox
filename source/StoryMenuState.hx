...
class StoryMenuState extends MusicBeatState
{
	...
	var weekData:Array<Dynamic> = [
		['Tutorial'],
		['Alpha', 'Little-Miss', 'Sunrise', 'The-Love', 'Brazil', 'Alive', 'Jeevan', 'Dystopia', 'Synthwave-Little-Miss']
	];
	...
	override function create()
	{
		...
		if(FlxG.save.data.traduzido == true)
			weekNames = ["", "Mande Sua Batida"];
		if(FlxG.save.data.traduzido == false)
			weekNames = ["", "Pump It Up And Chill"];
